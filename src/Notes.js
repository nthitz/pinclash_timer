...
export default function Challenge(props) {
  ...
  return (
    <div>
      <textarea className='container text-center border-0 focus:border hover:border h-10' placeholder='no notes for this challenge'  value={notes} onBlur={submit} onChange={e => setLocalNotes(e.target.value)}></textarea>
    </div>
  )
}
